...
Objections to cover: O1, O2, O7
Status:            ✅ Complete (text confirmed; factory photos pending)
```
...
ISO 9001:2015 quality management, ISO 14001:2015 environmental management, and ISO 45001:2018 occupational health and safety certifications all apply to the same production line. It's not a separate certified facility used for audits only. Each unit is tested before packing, with inspection reports available on request.
...
**Q: Can I visit the factory before placing a bulk order?**
A: Yes. Factory visits are welcome by appointment. Contact EASCO via WhatsApp or email to schedule one.

**Q: Is a video tour available if I can't travel to Shenzhen?**
...
**Q: Are photos of the factory available on this page?**
A: Factory photography is being finalized and will be added to this page once supplied. Request current photos directly in the meantime.
...
Send preferred dates for an in-person visit, or request a video tour covering specific areas of the facility.
...
- Factory exterior, production floor, and R&D area photos
