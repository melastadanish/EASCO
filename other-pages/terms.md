...
These terms govern use of szeasco.com and any quote, order, or inquiry submitted through it, operated by Shenzhen Easco Intelligent Equipment Co., Ltd. ("EASCO").
...
A quote submitted through this site is not a binding order. Pricing is confirmed in writing once a quote request is reviewed. Orders proceed based on terms agreed directly between EASCO and the buyer, including payment schedule, production timeline, and shipping terms.

**Product Specifications**

Product specifications on this site are sourced from EASCO's official documentation. ⚠️ Specific warranty terms and after-sales support periods are being finalized and will be confirmed in the sales contract for each order.

**Intellectual Property**

Product designs, patents, and content on this site belong to EASCO. Reproduction of site content or product designs without written permission is not authorized.

**Limitation of Liability**

⚠️ This section requires legal counsel input specific to EASCO's target export markets before publishing.

**Governing Law**

⚠️ This section requires legal counsel input to confirm the governing jurisdiction for international sales contracts before publishing.

**Contact for Terms Inquiries**

Shenzhen Easco Intelligent Equipment Co., Ltd.
