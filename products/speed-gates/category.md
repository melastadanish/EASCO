...
Pass A: 8.8/10
Pass B: 9 fixes applied (sentence-length splits, benefit-first rewrites)
Pass N: 10/10 turnstile terms present (throughput, passage width, anti-tailgating, anti-crush/anti-pinch, IP-relevant temp/humidity range, RS485, direction, flap/arm/cylindrical, opening speed, Wiegand referenced via integration)
Pass D: AI-quotable ✅ | FAQ 6 Q&As ✅ | Authority ✅ (50 persons/min, MCBF >30M cycles, <40dB, -20°C to +75°C) | GEO ✅
Pass C: Headlines ✅ | Objections ✅ (O5, O9, O10, O11, O12 covered) | CTAs ✅ (spec sheet → OEM inquiry → quote) | AI-score ~10%
Client Data Verified: 2026-07-08 (JX/星际 specs from Stargate_Speed_Gate_Product_Parameters_V1.0.xlsx via _system/product-specs/jx-stargate-iridescent-speed-gate.md; J/JF variants marked ⚠️ where dimensional specs remain unconfirmed)
...
```
Target URL:        /products/speed-gates/
Primary Keyword:   speed gate turnstile
Secondary Keywords: flap barrier turnstile, aluminum speed gate, Android speed gate
...
| Motor | Direct-drive servo motor, MCBF >30,000,000 cycles |
| Anti-Tailgating | 7 pairs infrared sensors (10 pairs optional) |
| Operating Temperature | -20°C to +75°C |
| Operating Humidity | 0–90% (non-condensing) |
| Power Supply | DC 24V–36V, 15A |
| Communication | RS485 / RS232 / IO |
| Noise Level | Under 40dB |
| Optional Terminal | Android face recognition, 100,000-face capacity, 200–300ms recognition speed |

**CTA:** [Download the JX specification sheet](#) or [request it on WhatsApp](https://wa.me/8613711422283)
...
A hotel lobby and a factory staff entrance don't need the same gate. The JX's RGB ambient lighting and flowing light-guidance effect suit spaces where the entrance is part of the first impression. The base J and JF variants suit back-of-house and staff-only entrances where function matters more than finish.

- **Hotel lobbies and corporate headquarters:** Customizable door panel shape and logo placement on the gate body, colour-coded RGB status lighting (blue standby, green pass, red denied).
...
The same aluminum gate body upgrades in stages. Order the J-series with just a card reader for basic access control. Add the ESBL terminal later and the gate becomes a JF Android model reading face, card, QR code, and password. Custom logo engraving, door panel shape, and RGB lighting colour scheme are available on the JX line. SDK and API documentation is available for buyers integrating the gate into existing access control software.
...
**Q: What's the difference between the J, JF, and JX speed gates?**
A: J is the base aluminum gate body with card-only access. JF adds an Android terminal for face, card, QR, and password access. JX is the flagship version with a faster motor, RGB lighting, and an optional 100,000-face Android terminal.

**Q: How fast does the gate process people?**
A: The JX processes 50 people per minute and opens in under 0.5 seconds, fast enough to clear a lobby rush without a queue forming at the door.

**Q: Can someone get hurt by the gate closing on them?**
A: Automatic anti-pinch detection stops the panel before contact. Seven pairs of infrared sensors detect anti-tailgating attempts, and the gate resets itself after each pass.

**Q: Will it work outdoors or in extreme temperatures?**
...
- [Cylindrical Turnstiles](/products/cylindrical-turnstiles/) — higher-throughput rotating-drum alternative
- [Android Turnstiles](/products/android-turnstiles/) — dedicated Android + biometric gate line
- [Face Recognition Terminals](/products/face-recognition/) — standalone terminals for the ESBL upgrade path
...
Send the entrance width and whether card-only or Android biometric access is needed, and get back a model recommendation (J, JF, or JX) with pricing for the confirmed order volume.

> **Request Pricing for J, JF, or JX Speed Gates**
...
```json
{
  ...
  "@type": "Product",
  "name": "JX Speed Gate Turnstile",
  "model": "JX",
  "description": "Aluminum speed gate turnstile processing 50 persons/min, opening in under 0.5 seconds, with optional Android face recognition terminal.",
  "brand": {
    "@type": "Brand",
    "name": "EASCO"
  },
