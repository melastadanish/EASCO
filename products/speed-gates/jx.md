...
Pass N: 6/6 terms present (throughput, MCBF, Android, servo motor, anti-tailing, liveness detection)
Pass D: AI-quotable ✅ | FAQ 5 Q&As ✅ | Authority ✅ (50/min, MCBF 30M+, <40dB) | GEO ✅
Pass C: Headlines ✅ | Objections ✅ (O9, O10, O11, O12 covered) | CTAs ✅ (spec sheet → quote) | AI-score ~9%
Client Data Verified: 2026-07-08 (All specs from _system/product-specs/jx-stargate-iridescent-speed-gate.md, official Stargate Speed Gate Product Parameters V1.0 sheet)
...
```
Target URL:        /speed-gates/jx/
Primary Keyword:   JX speed gate
...
A lobby entrance is the first thing a visitor judges a building by. The JX speed gate clears 50 people a minute through a flowing iridescent light effect, backed by a direct-drive servo motor rated for over 30 million open-close cycles. An optional onboard Android terminal adds face recognition at 99.98% accuracy, without a separate controller box.
...
| Stat | Value | Outcome |
|---|---|---|
| Throughput | 50 persons/min | Clears a 500-seat auditorium in 10 minutes |
| Motor lifespan (MCBF) | 30,000,000+ cycles | Roughly 16 years at 5,000 cycles/day before motor service |
| Gate opening speed | < 0.5 seconds | No queue backup at peak entry times |
| Noise level | < 40dB | Quiet enough for a hotel or executive lobby |
...
| Motor Lifespan (MCBF) | 30,000,000+ cycles |
| Infrared Sensing | 7 pairs standard, 10 pairs optional |
| Noise Level | < 40dB |
...
- **Hotel lobbies:** The iridescent light effect and quiet operation fit a guest-facing entrance without feeling like an airport security lane.
- **Corporate headquarters:** An onboard Android terminal handles staff face recognition at the same throughput as a manned reception desk.
- **Retail flagship stores:** Custom logo engraving on the aluminum gate body matches a brand's storefront design.
- **Exhibition centres:** 50 persons/min throughput handles high foot traffic during peak show hours without a bottleneck.
- **High-end residential towers:** Card or face-based access replaces a manned concierge desk at the building entrance.
...
**Q: What's the throughput of the JX speed gate?**
A: 50 persons per minute, with a gate opening speed of under 0.5 seconds.

**Q: Does the JX come with a biometric terminal included?**
...
**Q: What happens to the gate during a power outage?**
A: The gate fails open on power loss, so people are not locked in or blocked from exiting.
...
Send the passage width needed and whether the Android terminal should be included, and get back a configuration and price within one business day.

> **Request JX Speed Gate Pricing**
...
- Confirm "JX" is the current model code used commercially for the 星际 series
