...
```
Target URL:        /products/face-recognition/
Primary Keyword:   face recognition terminal
Secondary Keywords: face recognition access control, biometric terminal, facial recognition device
...
- **Nobody waits twice at the door.** 200–300ms recognition speed at 99.98% accuracy holds across the 7-inch, 8-inch, and 10.1-inch models.
- **A photo held up to the camera doesn't work.** Financial-grade liveness detection rejects photos, video replays, and printed faces.
- **50,000 faces fit onboard the standard model.** The compact 7-inch variant still holds 10,000 faces for smaller sites.
...
- **It plugs into what's already installed.** Ethernet, WiFi 2.4GHz, RS-485, Wiegand 26/34, and USB 2.0 interfaces ship on every model.
...
| RGB Camera | 2MP wide dynamic (standard); 8MP wide dynamic (premium) |
| Infrared Camera | 2MP |
...
| Installation | Wall-mount, desktop, floor-standing, or turnstile-integrated |
...
- **Corporate reception desks:** The 10.1-inch premium model with 8MP camera handles visitor registration and staff clock-in from one terminal.
- **Turnstile-integrated entrances:** The 7-inch ESBL variant embeds into the gate top, holding 10,000 faces for a staff-only access point.
...
Every display size shares the same 99.98% accuracy and liveness detection engine. The choice comes down to mounting style and face capacity, not recognition quality. Custom housing colour and branding are available through the OEM/ODM program above minimum order volume. SDK/API documentation supports custom enrollment or reporting builds.
...
A: 99.98% accuracy at 200–300ms recognition speed, consistent across the 7-inch, 8-inch, and 10.1-inch models.

**Q: Can it be fooled by a photo or a video on a phone screen?**
...
A: EASCO publishes 99.98% recognition accuracy for face models; a separate FAR/FRR figure specific to face recognition is being confirmed with the factory. Iris and palm vein models do have published FAR/FRR figures — see the [Palm Vein + Iris category](/products/palm-vein-iris/).
...
- [Android Turnstiles](/products/android-turnstiles/) — the same ESBL terminal, embedded into a gate
- [Palm Vein + Iris Recognition](/products/palm-vein-iris/) — higher-security biometric alternatives with published FAR/FRR
- [Handheld Face Recognition Terminals](/products/handheld-face-recognition/) — portable version for floor and field use
...
Send the installation style (wall, desktop, floor-standing, or turnstile-integrated) and expected face count, and get back a model recommendation with pricing.

> **Request Face Recognition Terminal Pricing**
...
- Published FAR/FRR specific to face recognition models (currently only overall accuracy % is confirmed)
