...
Pass N: 9/9 biometrics terms present (FAR, FRR, liveness detection, recognition distance, face/palm capacity, operating temperature, IP65, Android OS; IR illumination referenced via IR camera)
Pass D: AI-quotable ✅ | FAQ 6 Q&As ✅ | Authority ✅ (iris 1-in-10M, palm vein FAR 0.00001%, IP65) | GEO ✅
Pass C: Headlines ✅ | Objections ✅ (O13, O15, O16 covered) | CTAs ✅ (spec sheet → OEM → quote) | AI-score ~9%
Client Data Verified: 2026-07-08 (Source: _system/client-data-map/ESQV8.md and _system/client-data-map/MTH8.md, official client-supplied parameter sheets, 2026.)
...
```
Target URL:        /products/palm-vein-iris/
Primary Keyword:   palm vein recognition
Secondary Keywords: iris recognition system, contactless biometric access control, ESQV8, MTH8
...
| Face Recognition Accuracy | 99.98% | 99.98% |
| Face Recognition Speed | 200–300ms | 200–300ms |
| Face Capacity | 50,000 faces | 50,000 faces |
| Display | 8-inch, 800×1280 | 8-inch, 800×1280 |
| Operating System | Android | Android |
| RAM / Storage | 2GB / 32GB | 2GB / 32GB |
| Housing | Aviation-grade aluminum alloy | CNC-carved anodized aluminum alloy |
| IP Rating | IP65 | ⚠️ Not stated |
| Operating Temperature | -25°C to +75°C | -25°C to +75°C |
| Communication | Ethernet, WiFi, RS-485, Wiegand 26/34, USB 2.0, RJ45 | Ethernet, WiFi, RS-485, Wiegand 26/34, USB 2.0, RJ45 |
| Using Environment | Indoor, outdoor | Indoor, outdoor, night-time |
| Installation | Wall-mount, floor-standing, turnstile-integrated, desktop | Wall-mount (standard) |

**CTA:** [Download the ESQV8 or MTH8 specification sheet](#) or [request it on WhatsApp](https://wa.me/8613711422283)
...
- **Banks and financial institutions:** Palm vein's contactless, unspoofable read suits vault and server room access where liveness matters most.
- **Data centers:** Iris recognition's 1-in-10,000,000 misrecognition rate suits access points where a false acceptance carries the highest cost.
...
Both ESQV8 and MTH8 ship with face recognition active by default. Either specialty biometric can run as the primary credential instead, with face as a fallback. Installation options include wall-mount, floor-standing, turnstile-integrated, or desktop, so the same terminal fits a lobby, a server room door, or a turnstile top. Custom housing finish is available through the OEM/ODM program above minimum order volume.
...
**Q: What's the difference between palm vein and iris recognition?**
A: Palm vein (ESQV8) reads the vein pattern under the skin at 0.00001% FAR. Iris recognition (MTH8) scans the eye at a 1-in-10,000,000 misrecognition rate. Both combine with face recognition on the same terminal.

**Q: Is palm vein recognition more private than face recognition?**
A: Yes. Palm vein captures a subsurface vein pattern, not a facial image, which matters for sites with privacy or regulatory concerns about facial data collection.

**Q: Can it be fooled by a photo, mask, or fake print?**
A: No. Both ESQV8 and MTH8 include liveness detection, and palm vein specifically has no surface pattern that can be photographed or replicated.

**Q: How fast is the recognition?**
A: Palm vein reads in under 0.5 seconds. Iris recognition takes under 2 seconds. Face recognition on both terminals runs at 200–300ms.

**Q: Will it work outdoors or at night?**
...
- [Face Recognition Terminals](/products/face-recognition/) — standalone face-only alternative
- [Android Turnstiles](/products/android-turnstiles/) — pair with a turnstile-integrated terminal
- [Alcohol Detection Devices](/products/alcohol-detection/) — combine with biometric access for high-security sites
...
Send the security tier needed and preferred installation style, and get back a model recommendation (ESQV8 or MTH8) with pricing for the confirmed order volume.

> **Request Palm Vein or Iris Terminal Pricing**
...
- MTH8 gate/terminal body IP rating (currently unstated)
