# Differentiator Reference Card — EASCO

> Every product page must include minimum 2 differentiators from this card, stated explicitly in buyer language.
> Internal language on the left. What to write on the page on the right.
> Source every differentiator against client-data-map.md before using.

---

## Primary Differentiators — Use on Every Pillar + Product Page
...
## Secondary Differentiators — Use on Relevant Product Pages

| # | Internal Fact | Buyer Language Version | Relevant Silo | Verified |
|---|---|---|---|---|
| D9 | Cylindrical gate: 0.5-second opening | "The cylindrical speed gate opens in 0.5 seconds — fast enough for transit-grade throughput without a flap barrier footprint." | S1 Turnstiles | ✅ |
| D10 | Android speed gate — built-in OS | "The Android speed gate runs a full Android system onboard. No separate controller, no third-party integration required for basic biometric access." | S1 Turnstiles | ✅ |
| D11 | Alcohol detection + attendance combined | "The only attendance system in the range that mandates a breath test before clock-in. Legally defensible for construction, logistics and mining sites." | S4 Attendance | ✅ |
| D12 | Palm vein — contactless + unspoofable | "Palm vein reads the pattern of veins beneath the skin using near-infrared light. No surface to touch. No pattern that can be photographed or replicated." | S2 Biometrics | ✅ |
| D13 | Wireless sensor cylindrical gate — touchless entry | "Wireless sensor trigger — no card, no phone, no contact needed. Opens on proximity alone." | S1 Turnstiles | ✅ |
| D14 | Anti-crushing protection — crank-link transmission | "Crank-link transmission with magnetic-sensitive limit control stops the gate the instant it meets resistance. Tested mechanism — not software-only." | S1 Turnstiles | ✅ |
| D15 | Airport display: ultra-bright, 24/7 continuous | "Flight information displays rated for 24/7 continuous operation at sunlight-readable brightness — tested for airport deployment, not repurposed signage screens." | S5 Custom | ✅ |

---

## Differentiator Usage Rules
